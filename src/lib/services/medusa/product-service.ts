...
export const fetchProducts = async ({ slug, id, sid = null }: any) => {
  try {
    let res: AllProducts | {} = {}
...
export const fetchProduct = async ({ slug, id, sid = null }: any) => {
  try {
    let res: Product | {} = {}
...
export const fetchProduct2 = async ({ slug, vid, sid = null }: any) => {
  try {
    let res: Product | {} = {}
    const med = await getMedusajsApi(
